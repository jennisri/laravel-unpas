...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
	...
	<div class="col-lg-8">
		<form action="{{ url('dashboard/blogs/'.$blog->slug) }}" method="post" enctype="multipart/form-data">
			@csrf
			@method('put')
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				@if($blog->image)
				<img src="{{ asset('storage/'. $blog->image) }}" alt="" class="img-preview img-fluid mb-3 col-sm-5 d-block">
				@else
			...
			<div class="mb-3">
				...
				<textarea name="body" id="body" cols="30" rows="10" class="form-control @error('body') is-invalid @enderror" >{{ old('body', $blog->body) }}</textarea>
